...
//       const allTasks = (projectRes.data || []).flatMap((project) =>
...
//       <button
//         onClick={() =>
//           handleCompleteTask(project._id, task._id)
//         }
//         className="w-full bg-green-600 hover:bg-green-700 text-white text-xs font-medium py-2 rounded-xl transition-colors"
//       >
//         ✓ Mark as Completed
...
// //   // Set the task data into state so it displays on the screen
...
// //     console.log("Updated:", response.data);
// //     fetchData(); // Reload latest data to update main layout
// //   } catch (error) {
// //     console.error("Error updating task status:", error);
// //     alert("Failed to update task status");
// //   }
...
//                 {task.status?.toLowerCase() !== "completed" && (
//                   <button
//                     onClick={() => handleCompleteProject(task)}
//                     className="w-full bg-green-600 hover:bg-green-700 text-white text-xs font-medium py-2 rounded-xl transition-colors"
//                   >
//                     ✓ Mark as Completed
//                   </button>
...
//     try {
//       // Using your established 'api' instance rather than raw axios
//       const response = await api.put(
//         `/api/projects/${task.projectId}/tasks/${task._id}`,
//         { status: "Completed" }
//       );
...
//       // OPTION A: Instantly update locally without a full network flash reload
//       setTasks((prevTasks) =>
//         prevTasks.map((t) =>
...
//       // OPTION B: Keep this uncommented if your backend does heavy shifting and you need a fresh pull
//       // fetchData(); 
